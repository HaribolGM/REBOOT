    ...
    const featuresList = [
        {
            ...
            title: "3D Websites",
            desc: "We Providing 3D Websites using WebGL"
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                >
                    <div className="max-w-xl mx-auto text-center">
                        <h2 className="text-gray-50 text-3xl font-semibold sm:text-4xl">
                            Start your growing journey with Reboot Consultancy & Services
                        </h2>
                        <p className="mt-3">
                            Reboot Consultancy & Services makes it easy for you to create beautiful websites that get noticed and opened, track visitors, and build relationships with your customers.
                        </p>
                    </div>
                </LayoutEffect>
                <LayoutEffect
